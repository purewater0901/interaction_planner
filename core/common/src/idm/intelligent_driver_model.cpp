...
namespace common
{
    ...
    ErrorType IntelligentDriverModel::GetIdmDesiredAcceleration(const IntelligentDriverModel::Param &param,
                                                                ...
                                                                double *acc)
    {
        double s_star = param.kMinimumSpacing +
                        std::max(0.0,
        ...
        double s_alpha = std::max(0.0, cur_state.s_front - cur_state.s - param.kVehicleLength);
                                                                ...
                                                                double *acc)
    {
        ...
        double acc_cah = (cur_state.v * cur_state.v * -param.kComfortableBrakingDeceleration) /
        ...
        if (acc_iidm >= acc_cah)
            ...
            *acc = (1 - coolness) * acc_iidm + coolness *
                    (acc_cah - param.kComfortableBrakingDeceleration *
                    tanh((acc_iidm - acc_cah) / -param.kComfortableBrakingDeceleration));
        return kSuccess;
    }
